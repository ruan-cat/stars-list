...
| 仓库/分支/类型组合           | `10wms` + `dev` + `source-comment` + `validation`；状态栏 `2 可见 TODO`、页面无级滚动；清空类型后 `never-match-20260901` 为 0 并显示空状态                                                      | `browser-2026-09-01/dev-final-selected-1280x900-20260901.png` · `7B4261D574762A61AF926E2FDFA337827E664132F41B20F4940A3872A8A43775`；无匹配 `browser-2026-09-01/dev-final-no-match-1280x900-20260901.png` · `F749CA713D0E6EE7AAD61BFD9C74E702179C473943F9EED5E48CF35BF57D2154`                                                                                                                                                                     | 通过 |
